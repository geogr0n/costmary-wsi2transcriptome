...
- `backbone/he2rna_backbone.py`: HE2RNA-style aggregation path adapted through `sequoia-pub/src/he2rna.py`
- `backbone/tformer_lin.py`: ViS / SEQUOIA-style transformer path adapted from `sequoia-pub`
- `read_data.py`, `training.py`, `utils.py`, `main.py`, `run_train.sh`: training and data-handling code adapted from the same project family and trimmed for this repository
