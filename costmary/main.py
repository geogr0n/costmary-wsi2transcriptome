...
from backbone.tformer_lin import ViS
from backbone.he2rna_backbone import HE2RNABackbone
from backbone.spd_backbone import SpdBackbone
from backbone.mean_backbone import MeanBackbone
from backbone.projmean_backbone import ProjMeanBackbone
from training import train, evaluate

COSTMARY_ROOT = Path(__file__).resolve().parent
...
def parse_train_args(argv=None):
    """argv=None 时从 sys.argv 解析（供 `python main.py --ref_file ...`）；传入列表则用于测试。"""
